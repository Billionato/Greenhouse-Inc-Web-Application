...
<div id="cardContainer">
    ...
    <div id="cardBody">
        ...
        <a href="checkout_till.php"><input type="button" class="optButton" value="Checkout Till"></a>
        <a href="checkout_transactions.php"><input type="button" class="optButton" value="Edit Checkouts"></a>
        </div>
        <!--<div class="phForm">
        	&nbsp;
        </div>-->
