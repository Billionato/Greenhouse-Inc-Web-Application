...
<title>Board of Directors Home</title>
</head>
...
<div id="cardContainer">
    ...
    <div id="cardBody">
    	...
    	<div class="phMenu">
    	<a href="javascript:void();"><input id="optNextPage" type="button" class="optButton" value="Access Departments"></a>
        <!--<a href="admins.php"><input type="button" class="optButton" value="Edit Admins"></a>-->
        </div>
        <div class="phForm">
        	<a href="../Marketing/indexMarketing.php"><input type="button" class="optButton" value="Marketing"></a>
        	<a href="../Human_Resource/indexHr.php"><input type="button" class="optButton" value="Human Resource"></a>
            <a href="../Finance/indexFinance.php"><input type="button" class="optButton" value="Finance"></a>
        </div>
    </div>
</div>
</body>
